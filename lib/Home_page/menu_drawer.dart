...
class MainDrawer extends StatefulWidget {
  ...
  MainDrawer(@required this.eyu, @required this.first_name, @required this.Last_name, {Key key}) : super(key: key);

  @override
  _MainDrawerState createState() => _MainDrawerState(eyu, first_name, Last_name);
}
...
class _MainDrawerState extends State<MainDrawer> {
  ...
  final String first_name;
  final String Last_name;
  _MainDrawerState(@required this.eyu, @required this.first_name, @required this.Last_name);
